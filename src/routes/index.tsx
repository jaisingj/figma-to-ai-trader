...
function HeroReveal() {
  return (
    <div className="relative h-[480px] w-full overflow-hidden rounded-2xl border border-slate-200 bg-gradient-to-br from-slate-50 to-white">
...
const SCENE_DURATIONS = [7600, 5500, 11500, 3500, 14000, 5500];
