  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
      ...
      <section className="grid lg:grid-cols-2 gap-12 px-8 lg:px-20 pt-20 pb-24 max-w-7xl mx-auto items-start">
        ...
        {/* Right: bordered preview panel containing the shuffling cards */}
        <div className="hidden lg:block rounded-3xl border border-slate-200 bg-white/40 backdrop-blur p-6 h-[640px] overflow-hidden">
        <div className="relative grid grid-cols-2 gap-5 h-full overflow-hidden [mask-image:linear-gradient(to_bottom,transparent,black_8%,black_92%,transparent)]">
          {(() => {
            const cards = [
